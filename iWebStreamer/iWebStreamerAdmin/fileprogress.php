...
//session locking added by dave
require_once('sessionLock.php');

$tmp_dir = "/tmp";

$sessionid = $_POST['sid'];
$info_file = "$tmp_dir/$sessionid"."_flength";
$data_file = "$tmp_dir/$sessionid"."_iWebStream_postdata";
...
if ($started == TRUE) {
	...
	$decimal_percent_done = intval(($current_size / $total_size) * 100);
	$fractional_percent_done = (floor((($current_size / $total_size) * 10000)-($decimal_percent_done*100)))/100;
	$percent_done = $decimal_percent_done + $fractional_percent_done;
