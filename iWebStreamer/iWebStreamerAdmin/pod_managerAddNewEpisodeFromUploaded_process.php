...
action="pod_managerAddNewEpisodeFromUploaded_process_stage2.php?podcastId=<?echo $podcastId;?>" 
...
<table align="center" cellpadding="0" cellspacing="4" border="0">
	...
	<tr align="center" valign="center" bgcolor="#F1F2F8">
		...
		<td align="left">
			 <input type="text" name="author" id="author" value="<?echo $fileObj->getAuthor();?>" 
			 disabled>
		</td>
		<td align="left">
	...
	<tr valign="center">
		...
		<td align="left">
			<input type="text" name="duration" id="duration" value="<?echo $secs;?>" size="5"> seconds
		</td>
		<td align="left">
